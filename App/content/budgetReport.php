...
<script>
  ...
  function changeReport(value)
  {
    if(value == "All Data")
    {
      window.location = "index.php?display=BudgetReport&report=0";
    }
    if(value == "YTD Expenses")
    {
...
<h1 id="page-title" tabindex="-1" role="heading" aria-level="1">Budget Reports</h1>
...
<?php
  ...
  if($_GET['report'] == 1)
  {
    include 'reports/ytdExpenses.php';
  }
  if($_GET['report'] == 2)
  {
    include 'reports/fvsExpenses.php';
  }
