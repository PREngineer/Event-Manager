...
<script>
  ...
  function changeReport(value)
  {
    if(value == "All Data")
    {
      window.location = "index.php?display=MembershipReport&report=0";
    }
    if(value == "Membership by Career Level")
    {
      window.location = "index.php?display=MembershipReport&report=1";
    }
    if(value == "Membership by Company Segment")
    {
      window.location = "index.php?display=MembershipReport&report=2";
    }
  }
        ...
        <td style="padding:5px;">
          <div class="input-group">
            <select onchange="changeReport(this.value)" class="form-control" id="reportOptions">
              ...
              <option <?php if($_GET['report'] == 1){echo 'selected';} ?> value="Membership by Career Level">Membership by Career Level</option>
              <option <?php if($_GET['report'] == 2){echo 'selected';} ?> value="Membership by Company Segment">Membership by Company Segment</option>
            </select>
          </div>
        </td>
