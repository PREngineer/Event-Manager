...
<h1 id="page-title" tabindex="-1" role="heading" aria-level="1">Create New Announcement</h1>
...
<form class="container" method="POST" id="createAnnouncementForm">
  ...
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      <input name="Date" class="form-control" type="text" id="Date" placeholder="YYYY-MM-DD" aria-required="true">
    </div>
  </div>
