...
<script type="text/javascript" src="../lib/HTMLToX/jspdf.js"></script>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu " role="menu">
		<li>
      <a href="#" onClick ="$('#reportTable').tableExport({type:'json',escape:'false'});">
        <img src='../images/json.png' width='24px'>
        JSON
      </a>
    </li>
		<li>
      <a href="#" onClick ="$('#reportTable').tableExport({type:'json',escape:'false',ignoreColumn:'[2,3]'});">
        <img src='../images/json.png' width='24px'>
        JSON (ignore Column)
      </a>
    </li>
		<li>
      <a href="#" onClick ="$('#reportTable').tableExport({type:'json',escape:'true'});">
        <img src='../images/json.png' width='24px'>
        JSON (with Escape)
      </a>
    </li>
		<li class="divider"></li>
		<li>
      <a href="#" onClick ="$('#reportTable').tableExport({type:'xml',escape:'false'});">
        <img src='../images/xml.png' width='24px'>
        XML
      </a>
    </li>
		<li>
      <a href="#" onClick ="$('#reportTable').tableExport({type:'sql'});">
		...
		<li class="divider"></li>
		<li>
      <a href="#" onClick ="$('#reportTable').tableExport({type:'csv',escape:'false'});">
        <img src='../images/csv.png' width='24px'>
        CSV
      </a>
    </li>
		<li>
      <a href="#" onClick ="$('#reportTable').tableExport({type:'txt',escape:'false'});">
		...
		<li>
      <a href="#" onClick ="$('#reportTable').tableExport({type:'excel',escape:'false'});">
